...
import com.example.sophosmobileproject.databinding.FragmentMenuBinding
...
//        todo: See superior hamburguer menu
//        binding.menu.setOnClickListener{
//            findNavController().navigate(R.id.xxxx)
//        }
        binding.btnSendDocs.setOnClickListener{
            findNavController().navigate(R.id.action_menuFragment_to_sendFragment)
        }
        binding.btnDocs.setOnClickListener{
            findNavController().navigate(R.id.action_menuFragment_to_documentsFragment)
        }
